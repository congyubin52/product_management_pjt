...
const addManufacture = (m_no, m_name, m_address, m_phone, m_manager, m_reg_date, m_mod_date) => {
...
addManufacture(1,'A제조사', 'AAA시 aaa구 123-456', '010-1478-5236', 'A대리');
addManufacture(2,'B제조사', 'BBB시 bbb구 789-123', '010-1234-5678', 'B대리');
addManufacture(3,'C제조사', 'CCC시 ccc구 456-789', '010-4567-5236', 'C대리');
